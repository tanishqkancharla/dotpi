 ...
 *
 * Usage:
 *   /btw                                 (opens modal to type task, ctrl+space cycles mode)
...
import { loadAllModes } from "./lib/mode-utils.js";
  ...
  pi.registerCommand("btw", {
    ...
    handler: async (args, ctx) => {
      ...
      if (!task) {
        ...
        if (prompt.modeName) {
          const spec = modes[prompt.modeName];
          if (spec) {
